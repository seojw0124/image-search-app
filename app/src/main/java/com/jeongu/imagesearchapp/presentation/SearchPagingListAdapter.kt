...
class SearchPagingListAdapter(
    private val onClick: (SearchResultInfo) -> Unit
) : PagingDataAdapter<SearchResultInfo, RecyclerView.ViewHolder>(SearchDiffCallback()) {
...
private class SearchDiffCallback : DiffUtil.ItemCallback<SearchResultInfo>() {
